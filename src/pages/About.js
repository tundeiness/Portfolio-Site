...
const About = ({ title }) => (
  ...
  <div>
    ...
    <Content>
      ...
      If you plan on customizing the Bootstrap Sass files, or don`
      t want to use a CDN for the stylesheet, it may be helpful to install vanilla Bootstrap as well.
